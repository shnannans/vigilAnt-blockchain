...
contract VigilAnt is ChainlinkClient, ConfirmedOwner {
    ...
    struct DisasterEvent {
        ...
        string         gdacsEventId;  // GDACS event identifier for audit trail
    ...
    address[5] public validators; // store array for frontend to enumerate if needed
        ...
        recordChainlinkFulfillment(requestId)
    {
        ...
        if (isAlert) {
            ...
            disasterEvents[eventId] = DisasterEvent({
                countryCode:   countryCode,
                severity:      severity,
                gdacsEventId:  "", // Person B: populate this if the job returns an event ID
